...
local function YVXQRT_fake_script() -- Main.LocalScript 
...
coroutine.wrap(YVXQRT_fake_script)()
local function GDKT_fake_script() -- Draggable.LocalScript 
	local script = Instance.new('LocalScript', Draggable)

	script.Parent.Active = true
	script.Parent.Draggable = true
end
coroutine.wrap(GDKT_fake_script)()
local function MSJHDJB_fake_script() -- UpdateList.LocalScript 
...
coroutine.wrap(MSJHDJB_fake_script)()
